...
var SONAR_USER_MSG_TEMPLATE = "Is {company_name} a target customer for Thermo Fisher Scientific's Chromatography and Mass Spectrometry (CMD) division? Research the company's industry, analytical laboratory activities, published methods, job postings mentioning liquid chromatography (HPLC/UHPLC) trace elemental analysis (IOMS), ICP-OES, ICP-MS, ion chromatography (IC), PFAS, environmental safety, food testing, or mass spectrometry(MS),gas chromatgography (GC), and regulatory environment. CMD targets include companies operating in pharma, biotech, life sciences, environmental testing, food safety, clinical research,clinical diagnostic, forensic, toxicology, and industrial quality control organizations that purchase or operate LC, GC, HPLC, UHPLC, or mass spectrometry instruments. Default geography: Switzerland.";
